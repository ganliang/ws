...
<body>
	<div id="methodCallDiv" class="easyui-layout">
		...
		<!-- <div class="easyui-panel" region="center" style="width: 40%;"> -->
		    <div id="tt" class="easyui-tabs" data-options="tabPosition:'bottom'" region="center" style="width: 40%;">   
			    <div title="编程模式" data-options="closable:false" style="overflow:auto;">   
			        <textarea id="parameterTextArea" style="width: 99%;height: 99%"></textarea>    
			    </div>   
			    <div title="用户模式" data-options="closable:false" style="overflow:auto;">   
			        <form id="inputForm" method="post" title="方法调用"> 
			          <div style="margin-left: 40%">   
					      <label>方法调用</label>   
					  </div>
			          <div style="margin: 10px">   
					      <label for="name">name</label>   
					      <input style="margin-left: 10px;width: 80%;" class="easyui-validatebox" type="text" name="name" data-options="required:true" />   
					  </div>
					  <div style="margin-top: 20px;margin-left: 12%;">
					      <textarea title="方法说明" rows="10" style="width: 88%;height: 50%;">方法说明</textarea>  
					  </div> 
					  <div style="margin: 10px;margin-left: 40%;margin-bottom: 10%;">
